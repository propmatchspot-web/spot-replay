    ...
    return (
        ...
        <div className="space-y-10 pb-10 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {profile?.plan_tier === 'SPOT_EXCLUSIVE' && <InnerCircleCard plan={profile.plan_tier} />}
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <DashboardCard title="Hourly Performance" iconName="clock" color="brand-gold" minHeight="h-[350px]">
                    <TimePerformanceChart trades={trades || []} />
                </DashboardCard>
                <DashboardCard title="Duration vs P&L" iconName="scatter" color="amber" minHeight="h-[350px]">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                <DashboardCard title="Pair Performance" iconName="bar-chart" color="orange" minHeight="h-[350px]">
            ...
            <DashboardCard
                ...
                minHeight="min-h-0"
                headerAction={
                    <button className="text-sm text-brand-gold hover:text-amber-400 font-semibold tracking-wide transition-colors">
                        View All →
                    </button>
                }
            >
