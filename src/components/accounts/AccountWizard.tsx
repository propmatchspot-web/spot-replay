        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/90 backdrop-blur-md p-4">
            ...
            >
                ...
                <div className="relative border-b border-zinc-800 bg-zinc-900/50 p-6 text-center">
                    ...
                    <h2 className="text-2xl font-bold text-white bg-gradient-to-r from-amber-400 to-[#F7AE11] bg-clip-text text-transparent">
                        Setup Spot Replay
                    </h2>
                            ...
                            <div key={i} className="flex items-center">
                                <div className={cn(
                                    ...
                                    step === s || (steps.indexOf(step as string) > i)
                                        ? "bg-gradient-to-r from-amber-500 to-[#F7AE11]"
                                        : "bg-zinc-800"
                                )} />
                            </div>
                        ))}
                            ...
                            >
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        formData.type === 'LIVE'
                                            ? "border-[#F7AE11] bg-[#F7AE11]/10"
                                            : "border-zinc-800 bg-zinc-950 hover:border-zinc-700"
                                    )}
                                >
                                    <div className={cn(
                                        "rounded-full p-4 transition-colors",
                                        formData.type === 'LIVE' ? "bg-[#F7AE11] text-white" : "bg-zinc-900 text-zinc-500 group-hover:text-white"
                                    )}>
                                ...
                                >
                                    <div className={cn(
                                        "rounded-full p-4 transition-colors",
                                        formData.type === 'FUNDED' ? "bg-orange-500 text-white" : "bg-zinc-900 text-zinc-500 group-hover:text-white"
                                    )}>
                                        ...
                                        >
                                            <div className="flex-1 space-y-2">
                                                <div className="flex items-center gap-2">
                                                    <span className={cn("font-bold text-lg", formData.programType === prog.id ? "text-orange-400" : "text-white")}>
                                                        {prog.label}
                                                    </span>
                                                    {formData.programType === prog.id && <CheckCircle2 className="h-5 w-5 text-orange-500" />}
                                                </div>
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl border border-zinc-800 bg-zinc-950 p-4 text-white focus:border-[#F7AE11] focus:outline-none transition-colors"
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-xl border border-zinc-800 bg-zinc-950 p-4 text-white focus:border-orange-500 focus:outline-none"
                                        ...
                                        <div className="flex gap-2">
                                            <div className="relative flex-1">
                                                <input
                                                    ...
                                                    className="w-full rounded-xl border border-zinc-800 bg-zinc-950 p-3 text-white focus:border-orange-500 focus:outline-none"
                                                    placeholder="5"
                                                />
                                            ...
                                            <select
                                                ...
                                                className="w-24 rounded-xl border border-zinc-800 bg-zinc-950 p-3 text-xs text-white focus:border-orange-500 focus:outline-none"
                                            >
                                        ...
                                        {formData.type === 'FUNDED' && (
                                            <>
                                                ...
                                                <div>
                                                    ...
                                                    <dd className="text-[#F7AE11] font-medium">
                ...
                <div className="border-t border-zinc-800 bg-zinc-900/50 p-6 flex justify-between items-center">
                    ...
                    <button
                        ...
                        className={cn(
                            "flex items-center gap-2 rounded-xl px-8 py-3 text-sm font-bold text-black shadow-lg shadow-[#F7AE11]/20 transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100",
                            formData.type === 'LIVE' ? "bg-gradient-to-r from-amber-500 to-[#F7AE11]" : "bg-gradient-to-r from-orange-500 to-amber-500"
                        )}
                    >
