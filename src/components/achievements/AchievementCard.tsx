                ...
                <div className="w-full h-full bg-zinc-950 p-12 relative overflow-hidden flex flex-col items-center justify-center text-center border-[16px] border-double border-amber-900/30">
                    ...
                    <div className="relative z-10 flex flex-col items-center h-full w-full">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center w-full">
                            ...
                            <p className="text-xl text-zinc-400 mb-12 uppercase tracking-widest">Spot Replay</p>
                        ...
                        <div className="w-full flex items-end justify-between mt-auto pt-8 border-t border-zinc-800/50">
                            ...
                            <div className="flex flex-col items-end">
                                <div className="bg-white p-2 rounded-lg mb-2">
                                    <QRCodeCanvas
                            value="https://replay.propmatchspot.com/"
                                        size={80}
                                        level={"H"}
                                    />
                                </div>
                                <p className="text-[10px] text-zinc-600 font-mono">VERIFY AT REPLAY.PROPMATCHSPOT.COM</p>
                            </div>
                        </div>
                    </div>
                </div>
