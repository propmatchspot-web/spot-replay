    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: 'welcome',
            role: 'assistant',
            content: "Hello! I'm Spot Buddy, your AI trading assistant. I can analyze your trades, provide psychological tips, or discuss market concepts. How can I help you today?",
            timestamp: new Date()
        }
    ])
