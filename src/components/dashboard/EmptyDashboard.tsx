                ...
                <div className="space-y-6">
                    ...
                    >
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F7AE11] opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-[#F7AE11]"></span>
                        </span>
                    ...
                    <h1 className="text-5xl md:text-6xl font-black tracking-tight text-white">
                        Master Your <br />
                        <span className="bg-gradient-to-r from-amber-400 via-[#F7AE11] to-amber-600 bg-clip-text text-transparent">
                            Trading Edge
                        </span>
                    </h1>
