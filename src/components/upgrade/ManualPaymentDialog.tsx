                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={copyAddress} className="p-2 hover:bg-zinc-800 rounded-lg transition-colors">
                                            {copied ? <Check className="h-4 w-4 text-[#F7AE11]" /> : <Copy className="h-4 w-4 text-zinc-500" />}
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4 text-xs text-zinc-400">
                                    ...
                                    <ol className="space-y-2 list-decimal list-outside ml-4">
                                        ...
                                        <li>Once you get the confirmation, then enter the amount transferred along with the Proof of Transfer. - <span className="text-[#F7AE11] cursor-pointer hover:underline" onClick={() => setStep('details')}>Proceed</span></li>
                                ...
                                <div className="bg-[#161B22] p-3 rounded-lg flex gap-3 items-start border border-zinc-800/50">
                                    <Smartphone className="h-5 w-5 text-[#F7AE11] shrink-0 mt-0.5" />
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-[#F7AE11] hover:bg-[#D4960A] text-black font-bold rounded-xl transition-colors shadow-lg shadow-[#F7AE11]/20"
                                >
                                    Continue
                                </button>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[#0D1117] border border-zinc-700 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#F7AE11] transition-colors"
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[#0D1117] border border-zinc-700 rounded-xl px-4 py-3 text-white placeholder-zinc-600 focus:outline-none focus:border-[#F7AE11] transition-colors"
                                    />
                                </div>

                                <div className="space-y-2">
                                    <label className="text-block w-full">
                                        <div className="border border-dashed border-[#F7AE11]/50 bg-[#0D1117] hover:bg-[#161B22] rounded-xl p-8 flex flex-col items-center justify-center gap-4 cursor-pointer transition-colors group h-48 relative overflow-hidden">
                                            {file ? (
                                                <div className="z-10 text-center">
                                                    <Check className="h-8 w-8 text-[#F7AE11] mx-auto mb-2" />
                                                    <span className="text-sm font-medium text-[#F7AE11]">{file.name}</span>
                                                ...
                                                <>
                                                    ...
                                                    <div className="text-center z-10">
                                                        <p className="text-sm text-zinc-300 font-medium">Drag and drop your screenshot(s) or <span className="text-[#F7AE11] underline">Browse</span></p>
                                                        <p className="text-[10px] text-zinc-500 mt-1 uppercase font-bold tracking-wider">JPEG, PNG · Max 1 file(s) · 5 MB per file</p>
                                                    </div>
                                                </>
                                            )}
                                            {/* Gradient Overlay */}
                                            <div className="absolute inset-0 bg-gradient-to-t from-[#F7AE11]/10 to-transparent pointer-events-none" />
                                        </div>
                                ...
                                <button
                                    ...
                                    disabled={!txid || !file}
                                    className="w-full py-3.5 bg-[#F7AE11] hover:bg-[#D4960A] disabled:opacity-50 disabled:cursor-not-allowed text-black font-bold rounded-xl transition-colors shadow-lg shadow-[#F7AE11]/20 mt-auto"
                                >
                                    Submit
                                </button>
                            </div>
